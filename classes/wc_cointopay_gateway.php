...
class WC_Cointopay_Gateway extends WC_Payment_Gateway {
	...
	public function check_cointopay_response() {
		...
		if(200 !== $transactionData['status_code']){
			get_header();
			echo '<div class="container" style="text-align: center;"><div><div><br><br><h2 style="color:#ff0000">Failure!</h2><img style="margin:auto;"  src="' . esc_url(WC_Cointopay_Payments::plugin_url().'/assets/images/fail.png') . '"><p style="font-size:20px;color:#5C5C5C;">'.$transactionData['message'] .'</p><a href="' . esc_url(site_url()) . '" style="background-color: #ff0000;border: none;color: white; padding: 15px 32px; text-align: center;text-decoration: none;display: inline-block; font-size: 16px;" >Back</a><br><br></div></div></div>';
			 get_footer();
				exit;
		}
		else{
			...
			elseif($transactionData['data']['TransactionID'] != $ordtransactionid){
				get_header();
			echo '<div class="container" style="text-align: center;"><div><div><br><br><h2 style="color:#ff0000">Failure!</h2><img style="margin:auto;"  src="' . esc_url(WC_Cointopay_Payments::plugin_url().'/assets/images/fail.png') . '"><p style="font-size:20px;color:#5C5C5C;">Data mismatch! TransactionID doesn\'t match</p><a href="' . esc_url(site_url()) . '" style="background-color: #ff0000;border: none;color: white; padding: 15px 32px; text-align: center;text-decoration: none;display: inline-block; font-size: 16px;" >Back</a><br><br></div></div></div>';
			get_footer();
				exit;
			}
			elseif($transactionData['data']['Status'] != $ordstatus){
				get_header();
			echo '<div class="container" style="text-align: center;"><div><div><br><br><h2 style="color:#ff0000">Failure!</h2><img style="margin:auto;"  src="' . esc_url(WC_Cointopay_Payments::plugin_url().'/assets/images/fail.png') . '"><p style="font-size:20px;color:#5C5C5C;">Data mismatch! status doesn\'t match. Your order status is '. $transactionData['data']['Status'].'</p><a href="' . esc_url(site_url()) . '" style="background-color: #ff0000;border: none;color: white; padding: 15px 32px; text-align: center;text-decoration: none;display: inline-block; font-size: 16px;" >Back</a><br><br></div></div></div>';
			get_footer();
				exit;
			}
			...
			if (( 'paid' === $ordstatus ) && ( 0 === $notenough )) {
				...
				get_header();
				echo '<div class="container" style="text-align: center;"><div><div><br><br><h2 style="color:#ff0000">Failure!</h2><img style="margin:auto;"  src="' . esc_url(WC_Cointopay_Payments::plugin_url().'/assets/images/fail.png') . '"><p style="font-size:20px;color:#5C5C5C;">The payment has been failed.</p><a href="' . esc_url(site_url()) . '" style="background-color: #ff0000;border: none;color: white; padding: 15px 32px; text-align: center;text-decoration: none;display: inline-block; font-size: 16px;" >Back</a><br><br><br><br></div></div></div>';
				get_footer();
				exit;
			} else {
	...
	public function Cointopay_Crypto_Gateway_admin_js() {
		wp_enqueue_script( 'ctp-crypto-custom-js', WC_Cointopay_Payments::plugin_url().'/assets/js/ctp_crypto_custom_js.js', array(), '1.0.0', true );
